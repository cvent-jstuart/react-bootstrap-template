...
import { Tooltip, Popover, OverlayTrigger, ButtonToolbar, Button, Table, PageHeader, Grid, Row, Col } from "react-bootstrap";
...
export default class PopoversRoute extends React.Component {
  render() {
    const popoverLeft = (
